...
require File.expand_path '../../../../models/qu/backend/mongoid', __FILE__
...
describe Qu::Backend::Mongoid do
  ...
  describe 'completed' do
    it 'should be defined' do
      subject.respond_to?(:completed).should be true
    end
  end
  ...
  describe 'release' do
    ...
    it 'should add the job back on the queue' do
      reserved = subject.reserve(worker)
      reserved.id.should == payload.id
      subject.length(payload.queue).should == 0
